defmodule DataLoader do
  def load_data do
    test_image_list     = load_images("t10k-images-idx3-ubyte.gz",  10000)
    test_label_list     = load_labels("t10k-labels-idx1-ubyte.gz",  10000)
    training_image_list = load_images("train-images-idx3-ubyte.gz", 60000)
    training_label_list = load_labels("train-labels-idx1-ubyte.gz", 60000)
