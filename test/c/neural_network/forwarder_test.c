...
static void test_forward_for_activity() {
  ...
  assert(activity->input[0] == NULL);
  assert(matrix_equal(activity->input[1], layer_1_input));
  assert(matrix_equal(activity->input[2], layer_2_input));
  assert(matrix_equal(activity->input[3], layer_3_input));
  ...
  assert(matrix_equal(activity->output[0], layer_0_output));
  assert(matrix_equal(activity->output[1], layer_1_output));
