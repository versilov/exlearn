...
defmodule ExLearn.NeuralNetwork.Worker.NifsTest do
  ...
  test "#create_batch_data can be called" do
    ...
    first_path  = TestUtil.temp_file_path_as_list("exlearn-neural_network-worker-nifs_test_1")
    second_path = TestUtil.temp_file_path_as_list("exlearn-neural_network-worker-nifs_test_2")
